...
/-! Compatibility query interfaces for singleton defer prepared work.
...
-/
theorem executeRoot_completeObservation_of_singletonDefer (schema : Schema)
...
-/
theorem queryOutcome_exists_of_singletonDefer (schema : Schema)
