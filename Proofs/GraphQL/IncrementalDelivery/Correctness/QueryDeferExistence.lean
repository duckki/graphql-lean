...
/-! Compatibility query interfaces for defer-only prepared work.
...
-/
theorem executeRoot_completeObservation_of_deferOnly (schema : Schema)
...
-/
theorem queryOutcome_exists_of_deferOnly (schema : Schema)
